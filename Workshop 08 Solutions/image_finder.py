...
# a. '<img'
# b. Any number of characters (to allow for attributes
#    before the source attribute)
# c. ' src="'
# d. Any non-empty sequence of characters excluding '"'
# e. '"'
# f. Any number of characters (to allow for attributes
#    after the source attribute)
# g. '>'
#
